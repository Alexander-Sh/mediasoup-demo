			...
			.then(() =>
			{
				protooPeer.on('request', (request, accept, reject) =>
				{
					...
					switch(request.method)
					{
						...
						{
							logger.log('sendchatmessage:', request.data);

							this._protooRoom.spread(
								'newroommessage', request.data
							);
							accept();
						...
						{
							logger.log('benchmarkcommand:', request.data);

							this._protooRoom.spread(
								'benchmarkcommand', request.data, request.data.peerId
							);
							accept();
